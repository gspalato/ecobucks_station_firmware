...
void ui_MainScreen_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_GoToDisposalRegisterScreenButton, lv_color_hex(0x39B874), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_GoToDisposalRegisterScreenButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_GoToDisposalRegisterScreenButton, lv_color_hex(0x5EBA9F),
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui_GoToDisposalRegisterScreenButton, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui_GoToDisposalRegisterScreenButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_GoToDisposalRegisterScreenButton, LV_GRAD_DIR_HOR, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_GoToDisposalRegisterScreenButtonLabel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_GoToDisposalRegisterScreenButtonLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_GoToDisposalRegisterScreenButtonLabel, &ui_font_SyneSemiBold24,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
