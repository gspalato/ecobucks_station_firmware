...
void ui_DisposalRegisterScreen_screen_init(void)
{
    ...
    lv_obj_set_x(ui_DisposalRegisterHeaderBackButton, -335);
    ...
    lv_obj_set_style_text_font(ui_DisposalRegisterHeaderTitle, &ui_font_SyneBold30, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_WeightRelativeToMaxWeightBar, lv_color_hex(0xD9D9D9), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_WeightRelativeToMaxWeightBar, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui_WeightRelativeToMaxWeightBar, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_RegisterButton, lv_color_hex(0x39BA7B), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_RegisterButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_RegisterButton, lv_color_hex(0x5EBA9F), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui_RegisterButton, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui_RegisterButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_RegisterButton, LV_GRAD_DIR_HOR, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_RegisterButtonLabel, &ui_font_SyneSemiBold24, LV_PART_MAIN | LV_STATE_DEFAULT);
